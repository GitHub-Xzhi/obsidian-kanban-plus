...
const lang: Partial<Lang> = {
  ...
  'Maximum number of flow records kept per card. Oldest records are removed first. Setting this to 0 disables the limit.': '每张卡片最多保留的流转+回退记录总条数，超出后自动丢弃最旧的记录。填 0 表示不限制。',
