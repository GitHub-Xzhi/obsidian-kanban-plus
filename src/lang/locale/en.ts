...
const en = {
  ...
  'Back': 'Back',
  'Back time': 'Back time',
  'Show/hide all flow buttons': 'Show/hide all flow/back buttons',
  'Enable flow/back in settings first': 'Enable flow/back in settings first',
  'Show/hide all flow time': 'Show/hide all flow/back time',
  'Show flow buttons': 'Show flow/back buttons',
  'Hide flow buttons': 'Hide flow/back buttons',
  'View flow history': 'View flow/back history',
  'No flow history': 'No flow history',
  'Show flow buttons on cards': 'Enable flow/back',
  ...
  'Show/hide all created times': 'Show/hide all created times',
  'Show/hide all completed times': 'Show/hide all completed times',
  ...
  'Unable to find source list': 'Unable to find source list',
  ...
  'When toggled, cards will be grouped by completed date.':
    'When enabled, the list menu will show the option to group by completed time.',
